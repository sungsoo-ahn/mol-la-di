#!/bin/bash
# Train RAE decoder with production config
...
echo "Training RAE decoder (production)..."
uv run python src/scripts/train_rae_decoder.py configs/rae/qm9_rae_decoder.yaml
